                    ...
                    <div class="card">
                        ...
                        <div class="card-body px-75">
                          <div class="col-12">
                            ...
                            <a href="user-dashboard.html" class="btn btn-primary mr-1"><i class="feather icon-edit-1"></i> Reject</a>
                         </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    window.onload = function(){
        ...
        //makePutRequest("updateOrderStatus/5e9f688183b6f200455ea8b6",onSuccess,onFailure);
    }
</script>
